...
Tensor pow_avx2_d64(const Tensor& a, const Tensor& b); // Requires specialized impl or scalar loop
...
Tensor lt_avx2_d64(const Tensor& a, const Tensor& b);
Tensor le_avx2_d64(const Tensor& a, const Tensor& b);
Tensor gt_avx2_d64(const Tensor& a, const Tensor& b);
Tensor ge_avx2_d64(const Tensor& a, const Tensor& b);
Tensor eq_avx2_d64(const Tensor& a, const Tensor& b);
Tensor ne_avx2_d64(const Tensor& a, const Tensor& b);
